...
namespace TaskCoordination
{
    class BarrierDemo
    {
        // sometime wants to multiple worker thread working on a particular algorithm, all work threats have to complete stage 1 and 
        // then all other the work threats complete stage 2, you make this algorithm using Barrier
